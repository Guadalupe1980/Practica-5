...
/*
let menu = parseInt(prompt(`Menu de conversiones:
...
switch(menu){
    case 1:
        valor = Number(prompt("Ingrese los grados Celsius: "));
        alert("El resultado es " + ((valor * 1.8)+ 32) + " °F");
        break;
    case 2:
        valor = Number(prompt("Ingrese los grados Fahrenheit: "));
        alert("El resultado es " + ((valor - 32) / 1.8) + " °C");
        break;
    case 3:
        valor = Number(prompt("Ingrese los Metros: "));
        alert("El resultado es " + ((valor / 1000 )) + " km");
        break;
    case 4:
        valor = Number(prompt("Ingrese los Kilometros: "));
        alert("El resultado es " + ((valor * 1000 )) + " m");
        break;
}
*/
